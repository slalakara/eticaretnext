...
export default async function Groceries() {
  const {products} = await fetch("https://dummyjson.com/products/category/groceries").then(res => res.json());
        ...
        {products.map(x => (
          <li key={x.id}>
            ...
            <span>
              ...
              <Link href={"/groceries/" + x.id} className="detail">Detay Göster</Link>
            </span>
